                            ...
                            <>
                                <div className='MovieDetails'>
                                    <div className='LeftImg'>
                                        <img src={`data: ${contentType}; base64, ${poster_path} `} />
                                    </div>
                                    <div className='RightDetails'>
                                        <div className='AboutMovie'>
                                            ...
                                            <input onClick={handleChoose} type="button" value="Book tickets" />
                                                    ...
                                                    <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                                                        <form method='post'>
                                                            <div className='RadioBtn'>
                                                                ...
                                                                <input type="radio" id="html" name="amt" onClick={(e) => setVal(e.target.value)} value="1" />
                                                            </div>


                                                            <div className='RadioBtn'>
                                                                <label for="css">2</label>
                                                                <input type="radio" id="css" name="amt" onClick={(e) => setVal(e.target.value)} value="2" />
                                                            </div>

                                                            <div className='RadioBtn'>
                                                                <label for="javascript">3</label>
                                                                <input type="radio" id="javascript" name="amt" onClick={(e) => setVal(e.target.value)} value="3" />
                                                            </div>

                                                            <div className='RadioBtn'>
                                                                <label for="age1">4</label>
                                                                <input type="radio" id="age1" name="amt" onClick={(e) => setVal(e.target.value)} value="4" />
                                                            </div>

                                                            <div className='RadioBtn'>
                                                                <label for="age2">5</label>
                                                                <input type="radio" id="age2" name="amt" onClick={(e) => setVal(e.target.value)} value="5" />
                                                            </div>

                                                            <div className='RadioBtn'>
                                                                <label for="age3">6</label>
                                                                <input type="radio" id="age3" name="amt" onClick={(e) => setVal(e.target.value)} value="6" />
                                                            </div>

                                                            <div className='RadioBtn'>
                                                                <label for="age3">7</label>
                                                                <input type="radio" id="age3" name="amt" onClick={(e) => setVal(e.target.value)} value="7" />
                                                            </div>

                                                            <div className='RadioBtn'>
                                                                <label for="age3">8</label>
                                                                <input type="radio" id="age3" name="amt" onClick={(e) => setVal(e.target.value)} value="8" />
                                                            </div>

                                                            <div className="BtnBox">
                                                                {/* {!val ? (null) : <><Link to={"/selectseat/" + val} ><input onClose={handleSubmit} type="submit" value="Submit" /></Link></>} */}
                                                                <input onClick={(e) => handleCheck(e, movie_name)} type="submit" value="Submit" />
                                                            </div>
                                                        </form>
                                                    </Typography>
