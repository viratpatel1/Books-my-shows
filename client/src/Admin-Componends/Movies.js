            ...
            <Form method="POST" onSubmit={MoviesData}>
                <Row className="mb-3 px-5">
                    <Form.Group as={Col} className="mb-3" controlId="exampleForm.ControlTextarea1">
                        ...
                        <Form.Control type="text" name="movie_name" placeholder="Enter Name of the Movie" onChange={(e) => setMovieName(e.target.value)} />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formFile" className="mb-3">
                        <Form.Label>Release Date</Form.Label>
                        <Form.Control type="date" name="release_date" onChange={(e) => setDate(e.target.value)} />
                    </Form.Group>
                </Row>
                <Row className="mb-3 px-5">
                    <Form.Group as={Col} controlId="formFile" className="mb-3">
                        <Form.Label>Movie Poster</Form.Label>
                        <Form.Control type="file" name="poster_path" onChange={handleChange} />
                    </Form.Group>
                </Row>
                <Form.Group className="mb-3 px-5" controlId="exampleForm.ControlTextarea1">
                    <Form.Label>Description About Movie</Form.Label>
                    <Form.Control type="textarea" rows={3} name="description" onChange={(e) => setDesc(e.target.value)} placeholder="Write about the movie" />
